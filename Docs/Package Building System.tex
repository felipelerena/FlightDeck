...
\section{Logical structure}
	...
	\end{tikzpicture}}
	\caption{
		Database design. It does not secure unique filenames for Modules or Attachments. Additional code needs to 
...
\section{Maintaining and building Manifest}
	...
	\subsection{Attributes which will be obtained during the system build}
	...
	\begin{description}
		...
		\item[license] {\tt License:name} and {\tt License:url}
	\end{description}
	
	\subsection{Attributes being held inside Manifest object}
	
	\begin{description}
		\item[contributors] needs to be a comma separated list as current version will not give collaborative
			editing 
		\item[url] is just a string up to 255 chars
	\end{description}
