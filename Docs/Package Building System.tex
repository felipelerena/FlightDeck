...
\section{Export \xpi}
	...
	Be aware that it is possible and common to export \xpi\footnote{An \xpi\ installer module is a ZIP file 
	that contains a Package --- Manifest with all code needed to run the Addon} from partially unsaved data. 
	This happens when User will use the "Try in browser" functionality. In this case \xpi\ can not be send to 
