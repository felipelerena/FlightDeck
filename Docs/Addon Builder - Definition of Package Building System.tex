...
\section{Relations between database objects}
	...
	\vspace{0mm}\begin{tikzpicture}[
		...
		\node [module]		(UbLa1Mb)		at (10.5,-4)					{Ub:La.1:Mb}
			edge [->,created,bend right=30] node [createdlab,rotate=315,anchor=south] {saved by} (Ub)
			edge [->,ismodule] (UbLa1);
	\end{tikzpicture}
